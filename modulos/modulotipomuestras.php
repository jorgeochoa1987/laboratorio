...
if (isset($_POST['accion'])) 
	...
	if ($_POST['accion'] == 'guardar') 
	  ...
	  $sql = "INSERT INTO `tipoMuestras`( `nombre`, `descripcion`) VALUES ('$nombre','$descripcion')";
  ...
  if ($_POST['accion'] == 'actualizar') 
	...
	$sql = "UPDATE `tipoMuestras` SET `nombre` = '$nombre', `descripcion` = '$descripcion'  WHERE `id` = $id";
  ...
  if (isset($_POST['accion'])) 
	...
	if ($_POST['accion'] == 'eliminar') 
		...
		$sql = "DELETE FROM tipoMuestras WHERE id='".$ID."'";
  ...
  if ($_POST['accion'] == 'consultar') 
	  ...
	  $sql = "select id,nombre,descripcion  FROM tipoMuestras  WHERE id ='".$ID."'";
